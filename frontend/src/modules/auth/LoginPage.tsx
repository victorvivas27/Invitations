...
const safeReturnTo = (value: string | null) => value?.startsWith('/') && !value.startsWith('//') ? value : '/templates'
...
export function LoginPage() {
  ...
  return <AppLayout className="login-shell section-shell"><section className="login-card"><span className="pill">Acceso seguro</span><h1>Inicia sesión para crear tu invitación</h1><p>Tu cuenta permite asociar y conservar las invitaciones que publiques.</p>
    ...
    <div className="account-prompt"><span>¿Todavía no tienes una cuenta?</span><Link to={registrationUrl}>Crear cuenta</Link></div><Link className="login-back" to="/">Volver al inicio</Link></section></AppLayout>
}
