...
export function HomePage() {
  return <AppLayout activePage="home" className="redesigned-home" withFooter>
    <section id="inicio" className="home-hero home-section section-shell">
      ...
      <AnimatedSection className="hero-copy" direction="left">
        ...
        <div className="hero-actions"><Link className="primary-cta" to="/templates">Crear mi invitación</Link><Link className="secondary-cta" to="/templates">Ver plantillas</Link></div>
