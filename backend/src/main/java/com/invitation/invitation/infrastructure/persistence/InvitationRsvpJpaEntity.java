...
public class InvitationRsvpJpaEntity {
    ...
    @Column(name = "guest_name_normalized", nullable = false, length = 120)
    private String guestNameNormalized;
    ...
    public InvitationRsvpJpaEntity(UUID id, UUID invitationId, String guestName,
        ...
        this.guestNameNormalized = guestNameNormalized;
    ...
    public String getGuestNameNormalized() {
        return guestNameNormalized;
    }
