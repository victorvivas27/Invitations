...
public class JpaInvitationRepository implements InvitationRepository {
    ...
    public JpaInvitationRepository(SpringDataInvitationRepository repository) {
