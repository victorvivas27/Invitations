...
public class InvitationImageJpaEntity {
    ...
    @Column(name = "image_url", nullable = false, unique = true, length = 1000) private String imageUrl;
    @Column(name = "image_public_id", nullable = false, unique = true, length = 500) private String imagePublicId;
    @Column(name = "image_format", nullable = false, length = 20) private String imageFormat;
    ...
    @Column(name = "image_context", nullable = false, length = 20) private String imageContext;
    ...
    public InvitationImageJpaEntity(UUID id, UUID invitationId, UUID ownerId, String imageUrl,
        ...
        this.id = id; this.invitationId = invitationId; this.ownerId = ownerId;
        this.imageUrl = imageUrl; this.imagePublicId = imagePublicId; this.imageFormat = imageFormat;
        this.imageWidth = imageWidth; this.imageHeight = imageHeight; this.imageBytes = imageBytes;
        this.imageContext = imageContext; this.createdAt = createdAt;
    }
