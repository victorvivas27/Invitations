...
public class InvitationJpaEntity {
    ...
    private InvitationViewMode viewMode;
    @Enumerated(EnumType.STRING)
    @Column(name = "event_type", nullable = false, length = 40)
    private EventType eventType;
    @Column(name = "event_name", nullable = false, length = 120)
    private String eventName;
    @Column(name = "honoree_name", nullable = false, length = 100)
    private String honoreeName;
    @Column(name = "honoree_age")
    private Integer honoreeAge;
    ...
    @Column(name = "section_backgrounds", columnDefinition = "TEXT")
    private String sectionBackgrounds;
    @Column(name = "contact_info", columnDefinition = "TEXT")
    private String contactInfo;
    @Column(name = "share_title", length = 120)
    private String shareTitle;
    @Column(name = "share_description", length = 200)
    ...
    public InvitationViewMode getViewMode() {
        return viewMode;
    }
    ...
    public String getSectionBackgrounds() {
